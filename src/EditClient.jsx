...
export default function EditClient() {
    ...
    useEffect(() => {
        const fetchClient = async () => {
            if (!token) return;
            try {
                // Adjust this endpoint if your backend uses a different route to fetch a single client
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Adjust the exact endpoint route if your backend uses a different path (e.g., /clients/${id})
            ...
            if (res.ok) {
                ...
                const data = await res.json();
                setError(data.detail || "Failed to update client. Please try again.");
            }
        } catch (err) {
            ...
            <main className="dash-main">
                <header className="dash-topbar">
                    <div className="topbar-left">
                        ...
                        <div>
                            <h1 className="topbar-title">Update Client</h1>
                            <span className="topbar-subtitle">Modify existing client information</span>
                        </div>
                    </div>
