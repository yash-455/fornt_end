                ...
                <div className="addcase-content">
                    <div className="addcase-card">
                        ...
                        <div className="addcase-grid">
                            ...
                            <div className="addcase-field">
                                ...
                                <input
                                    ...
                                    onChange={setField("case_number")}
                                    className={errors.case_number ? "field-error" : ""}
                                />
                            ...
                            <div className="addcase-field">
                                ...
                                <input
                                    ...
                                    onChange={setField("case_name")}
                                    className={errors.case_name ? "field-error" : ""}
                                />
                            ...
                            <div className="addcase-field">
                                ...
                                <select
                                    ...
                                    onChange={setField("case_type")}
                                    className={errors.case_type ? "field-error" : ""}
                                >
                            ...
                            <div className="addcase-field">
                                ...
                                <select
                                    ...
                                    className={errors.client_id ? "field-error" : ""}
                                >
                            ...
                            <div className="addcase-field">
                                ...
                                <input
                                    type="text"
                                    placeholder="e.g. Ahmedabad Sessions Court"
                                    value={form.court}
                        ...
                        <div className="addcase-actions">
                            <button className="btn-cancel" onClick={() => navigate("/cases")}>
                                Cancel
                            </button>
